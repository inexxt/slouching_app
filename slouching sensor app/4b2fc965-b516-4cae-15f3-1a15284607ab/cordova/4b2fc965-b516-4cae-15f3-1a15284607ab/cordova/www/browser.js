...
(function (TDev) {
    ...
    (function (Browser) {
        ...
        function detect() {
            ...
            if (window.touchDevelopExec || window.mcefQuery) {
            ...
            if (!Browser.useConsoleLog && typeof console != "undefined" && typeof console.log == "function")
                Browser.useConsoleLog = true;
            ...
            Browser.audioWav = Browser.isGecko;
            if (Browser.isWP8app) {
                Browser.audioDataUrls = true;
                Browser.screenshots = true;
                Browser.audioWav = true;
        ...
        function unsupportedMessage(what, path) {
            if (what === void 0) { what = "TouchDevelop"; }
            if (path === void 0) { path = ""; }
            ...
            var genericMessage = function (problemHTML, upgradedBrowserName) {
                ...
                return message(problemHTML, upgradedBrowserName ? "<p>Follow these easy steps to run " + what + " on your device:</p>" + "<ol class='light'><li>open <b>" + upgradedBrowserName + "</b></li><li>navigate to <u>touchdevelop.com" + path + "</u>, or the short form <u>tdev.ly" + path + "</u></li></ol>" + "<p>You can copy&amp;paste the link into " + upgradedBrowserName + ".</p>" : undefined);
            };
            ...
            if (/ IEMobile\/[3-9]/.test(userAgent)) {
                ...
                if (!um || /ignoreAgent/.test(document.URL) || Browser.inCordova) {
                    ...
                    if (isIndex)
                        ...
                        supportedBrowsers("<p>Your browser is supported.</p>" + "<p><a href='" + getServiceUrl() + "/app/?c'>Open TouchDevelop</a></p>");
                }
                else {
